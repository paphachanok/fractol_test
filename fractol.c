...
/*   Updated: 2023/07/25 13:22:04 by ppoti            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	mlx_hook(frac.mlx.win_ptr, 2, (1L << 0), ft_keypress, &frac);  //! to close window, different from n'Ohm
	mlx_loop_hook(frac.mlx.mlx_ptr, do_none, &frac);
